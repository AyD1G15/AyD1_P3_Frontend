...
export class ServicioService {
  ...
  datosuser1= [
   ...
   accounts = [];
  agregar(idregalo,avaliavi,cantiti,chargeRate,active,name,img){
    let  obj: any = 
    {
    "idregalo":idregalo,
    "avaliavi":avaliavi,
...
postPago(form){//odl pago
  return this.http.post(this.get_domain()+'/buy',form)
}
  postUser(form){
...
setearparametros(msg){
  ...
  if(msg){
    ...
    msg.forEach(element => {
      console.log("el user2 es "+element.nombre)   
      
      let imagendefinida=element.foto
     if(!imagendefinida)imagendefinida= 
     "data:image/png;base64,"
    ...
    this.datosuser=datosuser1
      // console.log("el datosuser es "+this.datosuser)   
      console.log("el datosuser es "+JSON.stringify(this.datosuser))   

   // return this.http.post(this.get_domain()+'/login',data);
  }
  get_userid() { 
    console.log("el datosuser0999 es "+JSON.stringify(this.datosuser))   
